      ...
      <Card className="max-w-2xl border-white/10 bg-black/40 backdrop-blur-xl">
        ...
        <CardContent>
          ...
          <form action={updateProfile} className="flex flex-col gap-5">
            ...
            <Button
              type="submit"
              className="w-fit rounded-full bg-white font-heading text-xs uppercase tracking-widest text-[#05070D] transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-lg hover:shadow-white/15"
            >
              Save Profile
            </Button>
          </form>
